      ...
      features: [
        {
          ...
          properties: {
            description:
              "<strong>Aceh</strong><p><img src='URL_RUMAH_TRADISIONAL_ACEH' alt='Rumah Tradisional Aceh' width='100'><br>Title: Sultan<br>Rumah: Rumoh Aceh<br>Pakaian: Ulee Balang<br>Musik: Seudati, Rapai<br>Tari: Tari Saman, Tari Seudati<br>Senjata: Rencong<br>Bahasa: Aceh</p>",
          },
          geometry: {
            type: "Point",
